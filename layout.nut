...
class UserConfig {
   ...
   </ label="Select wheel layout", help="Select wheel type", options="vertical,horizontal", order=6 /> enable_list_type="vertical";
...
if ( my_config["enable_list_type"] == "vertical" )
{
...
local wheel_y = [ fly*0.875, fly*0.875, fly*0.875, fly*0.875, fly*0.875, fly*0.875, fly*0.8, fly*0.875, fly*0.875, fly*0.875, fly*0.875, fly*0.875, ]; 
...
{
if ( wheel_fade_ms > 0 && ( my_config["enable_list_type"] == "vertical") || my_config["enable_list_type"] == "horizontal")
{
